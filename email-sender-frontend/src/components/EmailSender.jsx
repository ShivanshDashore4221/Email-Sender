...
function EmailSender() {
    ...
    async function handleSubmit(event) {
        ...
        if (emailData.to === "" || emailData.subject === "" || emailData.message === "") {
            //  use lib react-hot-toast for valdiation message
    ...
    return (
        <div className="w-full min-h-screen flex justify-center items-center">
            <div className="email_card bg-white md:w-1/2 w-full mx-4 md:mx-0 dark:bg-gray-700 dark:text-white dark:border-none  p-4 rounded-lg border shadow">
...
<Editor
      ...
      />
                    ...
                    {sending && (<div className="loader flex flex-col gap-2 items-center justify-center mt-4">
                        <div role="status">
